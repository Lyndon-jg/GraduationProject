...
class HouTaiWindow(QtWidgets.QWidget):
    ...
    def init_tableWidget(self):
        ...
        #self.tableWidget.insertColumn(3)
    ...
    def loadData(self):
        ...
        for row in result:
            ...
            self.newItem4 = QTableWidgetItem(row[4])
            # 当前行数
    ...
    def addBtnClicked(self):
        ...
        if self.count_lineEdit.text() != '' and self.passwd_lineEdit.text() != '':
            ...
            if len(result) == 0:
                # 插入帐号
                sql = "INSERT INTO userTable VALUES(%s,%s,0,'0','0')"%(self.count_lineEdit.text(),self.passwd_lineEdit.text())
                self.connect_cursor.execute(sql)
